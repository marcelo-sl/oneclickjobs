...
public class CategoriesController(ApplicationDbContext context) : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("Name,Id,CreatedAt,CreatedBy,UpdatedAt,UpdatedBy")] Category category)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, [Bind("Name,Id,CreatedAt,CreatedBy,UpdatedAt,UpdatedBy")] Category category)
    {
        if (id != category.Id)
        {
            return NotFound();
